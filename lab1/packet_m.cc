...
void Packet::setMsgId(int msgId)
{
    this->msgId = msgId;
}
...
int Packet::getDest() const
{
    return this->dest;
}

void Packet::setDest(int dest)
{
    this->dest = dest;
}
...
std::string PacketDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return enum2string(pp->getType(), "msgType");
        default: return "";
    }
}
...
bool PacketDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setType((msgType)string2enum(value, "msgType")); return true;
